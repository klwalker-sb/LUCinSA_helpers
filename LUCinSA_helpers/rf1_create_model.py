...
def prep_test_train(df_in, out_dir, classification):
    ...
    training_pix_path = os.path.join(out_dir,f'{classification}_TRAINING.csv')
    holdout_pix_path = os.path.join(out_dir,f'{classification}_HOLDOUT.csv')
    df_train = df_in[df_in['TESTSET20'] == 0]
...
def multiclass_rf(trainfeatures, out_dir, classification, importance_method, ran_hold):
